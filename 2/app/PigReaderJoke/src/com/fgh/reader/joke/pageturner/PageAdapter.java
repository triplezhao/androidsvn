...
//		btn_tag.getBackground().setAlpha(180);
		...
		String bookn=FileNameDecodeUtil. getDecodeName(m_bookFactory.getFile().getName());
		tv_bookname.setText(bookn);
		tv_time.setText(PigDateUtil.getFormatDate(System.currentTimeMillis(), mContext));
		
		Button btn_menu=(Button) convertView.findViewById(R.id.btn_menu);
...
//				msg.what=0;
//				mhandHandler.handleMessage(msg);
//			}
//		});
		
		btn_menu.setOnTouchListener(new OnTouchListener() {
