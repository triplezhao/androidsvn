...
public class DateUtilsDef {
	...
	public DateUtilsDef(Context context){
	...
	public String twoDateDistance(Date startDate, Date endDate) {
		...
		if (year != 0) {
			returnStr = yearStr + context.getResources().getString(R.string.STR_YEARS);
		} else if (month != 0) {
			returnStr = monthStr + context.getResources().getString(R.string.STR_MONTHS);
		} else if (day != 0) {
			returnStr = dayStr + context.getResources().getString(R.string.STR_DAYS);
		} else if (hour != 0) {
			returnStr = hourStr + context.getResources().getString(R.string.STR_HOURS);
		} else {
			returnStr = minuteStr + context.getString(R.string.STR_MINUTES);
		}
		return returnStr;
	}
}
