...
import com.fgh.reader.joke.adapter.FileBookSelectAdapter;
import com.fgh.reader.joke.database.BookStoryBean;
import com.fgh.reader.joke.database.BookStoryDao;


public class DemoBookSelectActivity extends PigBaseActivity {
	private List<String> items = null;
	private List<String> paths = null;
//	private String rootPath = Environment.getExternalStorageDirectory().getPath()+"/";
//	private String rootPath = getFilesDir().getParent()+"/lib/";
	private String rootPath = "";
//	private String rootPath = "file:///android_asset/";
...
//		mPath.setText(filePath);
		...
		lv_files.setAdapter(new FileBookSelectAdapter(this, items, paths));
